...
func (ps *ProcServer) WebService() *restful.Container {
	...
	api.Route(api.POST("/{org_id}/{bk_biz_id}").To(ps.CreateProcess))
	api.Route(api.DELETE("/{org_id}/{bk_biz_id}/{bk_process_id}").To(ps.DeleteProcess))
	api.Route(api.POST("/search/{org_id}/{bk_biz_id}").To(ps.SearchProcess))
	api.Route(api.PUT("/{org_id}/{bk_biz_id}/{bk_process_id}").To(ps.UpdateProcess))
	api.Route(api.PUT("/{org_id}/{bk_biz_id}").To(ps.BatchUpdateProcess))

	api.Route(api.GET("/module/{org_id}/{bk_biz_id}/{bk_process_id}").To(ps.GetProcessBindModule))
	api.Route(api.PUT("/module/{org_id}/{bk_biz_id}/{bk_process_id}/{bk_module_name}").To(ps.BindModuleProcess))
	api.Route(api.DELETE("/module/{org_id}/{bk_biz_id}/{bk_process_id}/{bk_module_name}").To(ps.DeleteModuleProcessBind))
	...
	api.Route(api.POST("/template/{org_id}/{bk_biz_id}").To(ps.CreateTemplate))
	api.Route(api.PUT("/template/{org_id}/{bk_biz_id}/{template_id}").To(ps.UpdateTemplate))
	api.Route(api.DELETE("/template/{org_id}/{bk_biz_id}/{template_id}").To(ps.DeleteTemplate))
	api.Route(api.POST("/template/search/{org_id}/{bk_biz_id}").To(ps.SearchTemplate))
	api.Route(api.POST("/template/version/search/{org_id}/{bk_biz_id}/{template_id}").To(ps.SearchTemplateVersion))
	api.Route(api.POST("/template/version/{org_id}/{bk_biz_id}/{template_id}").To(ps.CreateTemplateVersion))
	api.Route(api.PUT("/template/vesrion/{org_id}/{bk_biz_id}/{template_id}/{version_id}").To(ps.UpdateTemplateVersion))
	api.Route(api.GET("/template/proc/{org_id}/{bk_biz_id}/{bk_process_id}").To(ps.GetProcBindTemplate))
	api.Route(api.PUT("/template/proc/{org_id}/{bk_biz_id}/{bk_process_id}/{template_id}").To(ps.BindProc2Template))
	api.Route(api.DELETE("/template/proc/{org_id}/{bk_biz_id}/{bk_process_id}/{template_id}").To(ps.DeleteProc2Template))
	api.Route(api.POST("/template/preview/{org_id}/{bk_biz_id}/{template_id}").To(ps.PreviewCfg))
	api.Route(api.POST("/template/create/{org_id}/{bk_biz_id}/{template_id}").To(ps.CreateCfg))
	api.Route(api.POST("/template/push/{org_id}/{bk_biz_id}/{template_id}").To(ps.PushCfg))
	api.Route(api.POST("/template/getremote/{org_id}/{bk_biz_id}/{template_id}").To(ps.GetRemoteCfg))
	api.Route(api.GET("/template/group/{org_id}/{bk_biz_id}").To(ps.GetTemplateGroup))
