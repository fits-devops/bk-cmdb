...
func (s *Service) WebService() *restful.Container {
	...
	api.Route(api.POST("/privilege/group/{org_id}").To(s.CreateUserGroup))
	api.Route(api.PUT("/privilege/group/{org_id}/{group_id}").To(s.UpdateUserGroup))
	api.Route(api.DELETE("/privilege/group/{org_id}/{group_id}").To(s.DeleteUserGroup))
	api.Route(api.POST("/privilege/group/{org_id}/search").To(s.SearchUserGroup))

	api.Route(api.POST("/privilege/group/detail/{org_id}/{group_id}").To(s.CreateUserGroupPrivi))
