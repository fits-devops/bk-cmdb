...
func (s *Service) WebService() *restful.Container {
	...
	api.Route(api.GET("/host/{host_id}").To(s.GetHostByID))
	api.Route(api.POST("/hosts/search").To(s.GetHosts))
	api.Route(api.POST("/insts").To(s.AddHost))
	api.Route(api.GET("/host/snapshot/{host_id}").To(s.GetHostSnap))
	...
	api.Route(api.PUT("/userapi/{biz_id}/{id}").To(s.UpdateUserConfig))
	api.Route(api.DELETE("/userapi/{biz_id}/{id}").To(s.DeleteUserConfig))
	api.Route(api.POST("/userapi/search").To(s.GetUserConfig))
	api.Route(api.GET("/userapi/detail/{biz_id}/{id}").To(s.UserConfigDetail))
