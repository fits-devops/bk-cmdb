...
func (s *Service) WebService() *gin.Engine {
	...
	ws.POST("/insts/owner/:org_id/object/:bk_obj_id/import", s.ImportInst)
	ws.POST("/insts/owner/:org_id/object/:bk_obj_id/export", s.ExportInst)
	ws.POST("/logout", s.LogOutUser)
	ws.POST("/object/owner/:org_id/object/:bk_obj_id/import", s.ImportObject)
	ws.POST("/object/owner/:org_id/object/:bk_obj_id/export", s.ExportObject)
