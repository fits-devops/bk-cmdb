...
func (s *Service) WebService() *gin.Engine {
	...
	ws.POST("/importtemplate/:obj_id", s.BuildDownLoadExcelTemplate)
	ws.POST("/insts/owner/:org_id/object/:obj_id/import", s.ImportInst)
	ws.POST("/insts/owner/:org_id/object/:obj_id/export", s.ExportInst)
	ws.POST("/logout", s.LogOutUser)
	ws.POST("/object/owner/:org_id/object/:obj_id/import", s.ImportObject)
	ws.POST("/object/owner/:org_id/object/:obj_id/export", s.ExportObject)
