...
func GetPropertyFieldType(lang language.DefaultCCLanguageIf) map[string]string {
	var fieldType = map[string]string{
		"property_id":         lang.Language("val_type_text"), //"文本",
		"property_name":       lang.Language("val_type_text"), //"文本",
		"property_type":       lang.Language("val_type_text"), //"文本",
		"property_group_name": lang.Language("val_type_text"), // 文本
...
func GetPropertyFieldDesc(lang language.DefaultCCLanguageIf) map[string]string {
	...
	var fields = map[string]string{
		"property_id":         lang.Language("web_en_name_required"),       //"英文名(必填)",
		"property_name":       lang.Language("web_bk_alias_name_required"), //"中文名(必填)",
		"property_type":       lang.Language("web_bk_data_type_required"),  //"数据类型(必填)",
		"property_group_name": lang.Language("property_group"),             // 字段分组
