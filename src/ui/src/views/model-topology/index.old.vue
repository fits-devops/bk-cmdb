<template>
    <div class="topo-wrapper" :class="{ 'has-nav': topoEdit.isEdit }">
        ...
        <div class="global-model" ref="topo" v-bkloading="{ isLoading: loading }"
            ...
            @mousewheel="handleGraphicsScroll">
        </div>
        ...
        methods: {
            ...
            popupNodeTooltips (data) {
                ...
                this.$nextTick(() => {
                    ...
                    deleteNodeIcon.style.transform = `scale(${scaleRatio})`
            ...
            addListener () {
                ...
                networkInstance.on('hoverNode', data => {
                    networkInstance.selectNodes([data.node])
                ...
                networkInstance.on('zoom', data => {
                    this.network.scale = parseFloat(data.scale.toFixed(2))
                    this.clearActiveEdge()
                    this.clearHoverTooltip()
                })
