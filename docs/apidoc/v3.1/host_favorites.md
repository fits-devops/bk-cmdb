...
```
{
    "info":"{\"biz\":{\"biz_id\":12},\"exact\":0,\"host_innerip\":true,\"host_outerip\":true,\"ip\":[]}",
    "query_params":"[{\"biz_id\":12,\"obj_id\":\"host\",\"field\":\"bk_agent_status\",\"operator\":\"$eq\",\"value\":\"正常\"},{\"biz_id\":12,\"obj_id\":\"host\",\"field\":\"CPUModule\",\"operator\":\"$regex\",\"value\":\"123\"},{\"biz_id\":12,\"obj_id\":\"biz\",\"field\":\"default\",\"operator\":\"$ne\",\"value\":1}]",
    "is_default":2,
    "name":"my5"
}
```
...
| host_innerip|bool|是|无|true 或者false| true or false|
| host_outerip|bool|是|无|true 或者false|true or false|
...
```
{
    ...
    "info":"{\"biz\":{\"id\":biz_id},\"exact\":0,\"host_innerip\":true,\"host_outerip\":true,\"ip\":[]}",
    "is_default":2,
    "name":"my211",
    "query_params":"[{\"biz_id\":12,\"obj_id\":\"biz\",\"field\":\"default\",\"operator\":\"$ne\",\"value\":1}]"
}
```
...
```
{
    ...
    "data":{
        "count":1,
        "info":[
{"count":1,"id":"bacb3j4kd42325venmag","info":"{\"biz\":{\"biz_id\":12},\"exact\":0,\"host_innerip\":true,\"host_outerip\":true,\"ip\":[]}","is_default":2,"name":"my2","bk_query_params":"[{\"biz_id\":12,\"obj_id\":\"biz\",\"field\":\"Default\",\"operator\":\"$ne\",\"value\":1}]"}
        ]
    }
}
```
